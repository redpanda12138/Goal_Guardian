<template>
  <view>
    <view class="pronunciation-content">
      ...
      <view v-if="pronunciationResult" class="pronunciation-tips">Tap to review word scores</view>

      <TextPronunciation
        v-if="pronunciationResult"
        :content="messageContent"
        :pronunciation="pronunciationResult"
        @wordClick="handleWordDetail"
      />
    ...
    <view class="practice-box">Practice</view>
...
const { globalUserInfo } = useUserInfo();
...
.pronunciation-content {
  ...
  .voice-box {
    ...
    .original-voice-box {
      ...
      justify-content: center;
      align-items: center;
      box-shadow: 0 0 8px 0 rgba(196, 196, 196, 1);
